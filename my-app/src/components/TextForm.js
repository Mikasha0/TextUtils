...
export default function TextForm(props) {
  ...
  return (
    <>
      <div
        className="container"
        style={{ color: props.btnMode === "light" ? "black" : "white" }}
      >
        <div className="mb-3" style={{ marginTop: "7rem" }}>
          <h1>Enter the text below to analyze</h1>
          <textarea
            className="form-control"
            style={{
              backgroundColor: props.btnMode === "light" ? "white" : "grey",
              color: props.btnMode === "light" ? "grey" : "white",
            }}
